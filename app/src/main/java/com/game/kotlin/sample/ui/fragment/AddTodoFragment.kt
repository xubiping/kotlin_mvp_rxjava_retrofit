...
import com.game.kotlin.sample.ext.formatCurrentDate
import com.game.kotlin.sample.ext.showToast
import com.game.kotlin.sample.ext.stringToCalendar
import com.game.kotlin.sample.mvp.contract.AddTodoContract
import com.game.kotlin.sample.mvp.model.bean.TodoBean
import com.game.kotlin.sample.mvp.presenter.AddTodoPresenter
...
class AddTodoFragment : BaseMvpFragment<AddTodoContract.View, AddTodoContract.Presenter>(), AddTodoContract.View {
    ...
    private val mDialog by lazy {
        DialogUtil.getWaitDialog(requireActivity(), getString(R.string.save_ing))
    }
